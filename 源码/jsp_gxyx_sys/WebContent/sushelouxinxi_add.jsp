...
<script language="javascript">
	...
	function gow() {
		document.location.href = "sushelouxinxi_add.jsp?jihuabifffanhao="
...
<body>
	...
	<form name="form1" id="form1" method="post"
		action="sushelouxinxi_add_post.jsp">
		添加宿舍楼信息: <br>
		<br>
		<table width="100%" border="1" align="center" cellpadding="3"
			...
			<tr>
				<td>楼号：</td>
				<td><input name='louhao' type='text' id='louhao' value=''
					style='border: solid 1px #000000; color: #666666' />&nbsp;*</td>
			</tr>
			<tr>
				<td>层数：</td>
				<td><input name='cengshu' type='text' id='cengshu' value=''
					style='border: solid 1px #000000; color: #666666' />&nbsp;*</td>
			</tr>
			<tr>
				<td>楼管员：</td>
