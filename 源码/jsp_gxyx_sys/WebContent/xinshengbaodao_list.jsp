...
<body>
	...
	<table width="100%" border="1" align="center" cellpadding="3"
		...
		<tr>
			...
			<td width="60" align="center"><a
				href="xinshengbaodao_updt.jsp?id=<%=id%>">修改</a> <a
	...
	<p align="center">
		&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record%>条/页 <a
			href="xinshengbaodao_list.jsp?page=1">首页</a> <a
			href="xinshengbaodao_list.jsp?page=<%=curpage - 1%>">上一页</a> <A
			href="xinshengbaodao_list.jsp?page=<%=curpage + 1%>">下一页</A> <a
			href="xinshengbaodao_list.jsp?page=<%=zys%>">尾页</A> 当前第<FONT
